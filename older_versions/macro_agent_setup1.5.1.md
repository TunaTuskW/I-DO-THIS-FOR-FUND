# 24/7 Macro Analyst Agent Setup (v1.5.1)
...
8. Run the Discord notification script, passing the escalation tier as the 
   second argument:
   `python3 push_to_discord.py "macro briefing (YYYY-MM-DD HH:MM UTC).md" [TIER]`
